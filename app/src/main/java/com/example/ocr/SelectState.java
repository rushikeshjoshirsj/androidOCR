...
public class SelectState extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProposedInsured proposedInsured = new ProposedInsured();
        proposedInsured.setAddressLine1(spinner.getSelectedItem().toString());
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //intent.putExtra("proposedInsured", (Parcelable) proposedInsured);
